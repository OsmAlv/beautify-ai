...
-- ByteDance Pretty
('bytedance', 'pretty', NULL, 'Make this woman naturally more beautiful. CRITICAL: Preserve exact facial features - same face shape, nose, lips, eyes, eyebrows, jawline. Keep her identity intact. Preserve all skin texture details, natural freckles, beauty marks and skin imperfections - keep them visible. Enhance skin tone subtly, brighten eyes gently, add subtle glow. Keep her natural facial features and expressions identical to original. Skin must look like real human skin, not plastic or overly smooth. Keep body proportions. Maintain original outfit. Remove any objects from hands and neck. Shot like iPhone 17 Pro Max. Photorealistic, natural, living appearance.'),

-- ByteDance Hot Original
('bytedance', 'hot', 'original', 'Transform this woman into a stunningly attractive version of herself. CRITICAL: Keep exact same face - preserve face shape, nose, lips, eyes, eyebrows, chin. Identity must remain identical. Keep original background. IMPORTANT: Make it look like ONE unified professional photo shot on iPhone 17 Pro Max - blend seamlessly. Preserve skin texture, natural marks, freckles and minor imperfections - enhance beauty while keeping skin realistic and living, NOT plastic. Keep body proportions, enhanced features but natural looking. Keep face expressions and personality identical. Remove any objects from hands and neck. Photorealistic result with natural human skin texture. make this woman sexy, work with outfit to show tits and mark body lines'),
